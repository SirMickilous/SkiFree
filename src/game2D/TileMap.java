...
public class TileMap {
	...
	/**
	 * Creates a new TileMap to the specified dimensions and populates it with Tiles of char '.'
	 * 
	 * @param width		The width of the Tile Map
	 * @param height	The height of the Tile Map
	 * @param th		The width of each Tile in pixels
	 * @param tw		The height of each Tile in pixels
	 * @param img		The imagemap of the of the Tiles in the Tile Map
	 */
	public boolean newBlankMap(int width, int height, int th, int tw, Map<String, Image> img) {
		...
		for (int col = 0; col < mapWidth; col++) {
			for (int row = 0; row < mapHeight; row++) {
				tmap[col][row] = new Tile(c, col*tileWidth, row*tileHeight);
			}
		}
		return true;
	...
	/**
	 * Gets this TileMaps associated imagemap
	 * 
	 */
	public Map<String, Image> getImageMap() {
		Map<String, Image> rtn = imagemap;
			return rtn;		
	}
}
